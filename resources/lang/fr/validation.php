...
return [
    ...
    */
    ...
    "phone_number"         => "Le champ :attribute doit être un téléphone valide.",
    "siren"                => "Le champ :attribute doit être un numéro siren valide.",
    "alpha_sp"             => "Le champ :attribute doit seulement contenir des lettres et des espaces.",
    "alpha_num_sp"         => "Le champ :attribute doit seulement contenir des chiffres, des lettres et des espaces.",
